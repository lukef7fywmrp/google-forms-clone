...
import { Code, Facebook, Link2, Mail, Send, Twitter } from "lucide-react";
import EmailTabContent from "./EmailTabContent";
import EmbedTabContent from "./EmbedTabContent";
              ...
              <div className="flex items-center gap-x-3">
                ...
                {tabs.map((tab) => (
                  <TabsTrigger
                    ...
                    value={tab.value}
                    className={
                      "flex-col !p-0 group after:content-[''] after:h-[3px] data-[state=active]:text-violet-900 text-neutral-950 data-[state=active]:after:bg-violet-900 after:w-full after:mt-2 after:rounded-t-full"
                    }
                    asChild
                  >
